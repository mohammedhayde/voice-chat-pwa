...
export default function ChatSection({
  ...
  return (
    <div className="bg-white/10 backdrop-blur-2xl border border-white/10 rounded-2xl flex flex-col flex-1 overflow-hidden">
      {/* Chat Header */}
      <div className="flex items-center justify-between px-4 sm:px-6 py-3 sm:py-4 border-b border-white/10 flex-shrink-0 bg-white/5">
        <div className="flex items-center gap-2 sm:gap-3">
          <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-gradient-to-br from-purple-500 to-pink-600 flex items-center justify-center text-lg sm:text-xl shadow-lg">
            💬
          </div>
          <div>
            <h2 className="text-base sm:text-xl font-bold text-white">الدردشة النصية</h2>
      ...
      {/* Messages */}
      <div className="flex-1 overflow-y-auto px-3 sm:px-6 py-3 sm:py-4 space-y-3 scrollbar-thin scrollbar-thumb-white/20 scrollbar-track-transparent">
        {messages.length === 0 ? (
      ...
      {/* Message Input */}
      <div className="px-3 sm:px-6 py-3 sm:py-4 border-t border-white/10 flex-shrink-0 bg-white/5">
        {!isChatConnected && (
          <p className="text-xs text-center text-yellow-200 mb-2 sm:mb-3 animate-pulse">
